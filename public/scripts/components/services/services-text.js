    ...
    render() {
        return (
            <div className="left-panel">
                <div className="panel">
                    <div className="title padBottom">
                        <h1>Services</h1>
                        <h2>Lorem ipsum dolor sit amet consectetur adipiscing elit </h2>
                    </div>
                    <div className="clear"></div>
                    <div className="content marbottom30"> <img src="images/img3.jpg"/>
                    ...
                    <div className="clear"></div>
                    <div className="content marbottom30"> <img src="images/img1.jpg"/>
                    ...
                    <div className="clear"></div>
                    <div className="content marbottom30"> <img src="images/img2.jpg"/>
                    ...
                    <div className="clear"></div>
                    <div className="content"> <img src="images/img2.jpg"/>
